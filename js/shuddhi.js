...
jQuery(document).ready(function( $ ) {
    ...
    $('#header .blockcart .product-container').slimScroll({
      height: $('#header .blockcart .product-container .product').length > 1 ? '305px':'100%'
    });
	...
	$('#ishi-product-accessories-6.owl-carousel').owlCarousel({
        loop:false,
        rewind:true,
        nav:true,
        dots:false,
	...
	$('#ishi-product1-accessories.owl-carousel').owlCarousel({
        loop:true,
        rewind:true,
        nav:true,
        dots:false,
	...
	$('#ishi-product-accessories1.owl-carousel').owlCarousel({
        loop:true,
        rewind:true,
        nav:true,
        dots:false,
		...
		$('#ishi-product-accessories2.owl-carousel').owlCarousel({
        loop:true,
        rewind:true,
        nav:true,
        dots:false,
    ...
    $('#manufacturer-carousel1').owlCarousel({
        loop:true,
        nav:false,
        rewind:true,
        dots:false,
...
function adjustTopMenu() {
	$('#_desktop_top_menu #top-menu > li').each(function( index ) {
	  ...
	  switch(li) {
	  	...
	  	break;
	  	case 2 : $(this).find('.sub-menu').css('width','210px');
	  	break;
	  	default : $(this).find('.sub-menu').css('width','250px');
	  }
    });
}
